...
@ManagedBean(name="vetOrg")
@ViewScoped
public class VetOrganizationFacade implements Serializable {
	...
	public VetOrganizationFacade(){
		...
		if (rola != 1226 && rola != 1012){
	    	...
	    	System.out.println("ID KORISNIK: " + ub.getIdKorisnik());
			this.ub = ub;
			
			lazyModel = new LazyVetOrganizationDataModel();
		}
	}
	...
	public void search(ActionEvent event){
		try {
			...
			lazyModel = new LazyVetOrganizationDataModel(map);
		}
		catch (Exception e){
			e.printStackTrace();
		}
