...
public class BigDecimalConverter implements Converter {
    ...
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String value) {
        ...
        if (bd != null) {
        	if (bd.compareTo(BigDecimal.ZERO) <= 0) {
        		FacesMessage msg = new FacesMessage("fieldMsgs_"+arg1.getClientId(arg0),"Broj mora biti veæi od 0!");
    ...
    private void postMessageZeroValue(FacesContext fc, UIComponent comp) {
        FacesContext.getCurrentInstance().addMessage(comp.getClientId(fc),
                new FacesMessage(FacesMessage.SEVERITY_ERROR,null,"Broj mora biti veæi od 0!"));
    }
}
